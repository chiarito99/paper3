...
# K2 = [ [59, -40],[40, -20], [-10,-40], [-46,-30],[-36.5,-8], [-63, 24],[-60, 48],[-45,45],[-31, 56] ,  [52, 26]] 
# K2 = [ [59, -40],[40, -20], [-10,-40], [-46,-30],[-36.5,-8], [-63, 24],[-60, 48],[-45,45],[-31, 56] ,  [52, 26]] 
# K2 = [ [59, -40],[40, -20], [-10,-40],  [-63, 24],[-60, 48],[-45,45],[-31, 56],[-3,45], [20,56] ,  [52, 26]] 
# K2 = [ [59, -40],[40, -20], [15, -30],[26, -39],[-10,-40],  [-63, 24],[-60, 48],[-45,45],[-31, 56],[52, 26]] 
# K2 = [ [59, -40],[40, -20], [15, -30],[26, -39],[-10,-40],  [-63, 24],[-62.04950495049505, 31.603960396039604],[-31, 56],[52, 26]] 
...
for i in range(len(result)):
    ...
    print(array)
    x,y = cp.planning(0.7,1,array[:,0],array[:,1],[],0)
    plt.plot(x,y)
